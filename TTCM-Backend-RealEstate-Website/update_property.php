...
if (isset($_GET['get_id'])) //kiểm tra xem có tham số get_id được truyền vào trên URL hay không
{
    $get_id = $_GET['get_id'];
} else {
    $get_id = '';
...
if (isset($_POST['update'])) {
    ...
    $image_01 = $_FILES['image_01']['name']; //lấy giá trị của tệp tin ảnh đại diện được chọn để tải lên
    $image_01 = filter_var($image_01, FILTER_SANITIZE_STRING);
    $image_01_ext = pathinfo($image_01, PATHINFO_EXTENSION); //lấy phần mở rộng của tệp tin ảnh được chọn
    $rename_image_01 = create_unique_id() . '.' . $image_01_ext; //tạo ra một định danh duy nhất cho tệp tin ảnh đại diện mới được tải lên bao gồm cả phần mở rộng
    $image_01_tmp_name = $_FILES['image_01']['tmp_name']; //lưu trữ tên tệp tin tạm thời này để sau đó di chuyển tệp tin đến thư mục lưu trữ của trang web
    $image_01_size = $_FILES['image_01']['size'];
    $image_01_folder = 'uploaded_files/' . $rename_image_01; //Đường dẫn thư mục đích được lưu trữ trong biến $image_01_folder
    ...
    if (!empty($image_01)) {
        if ($image_01_size > 2000000) {
            ...
            if ($old_image_01 != '') {
                ...
                // xóa tệp tin ảnh cũ trong đường dẫn uploaded_files/ trên hệ thống của máy chủ ->giảm tải trên hệ thống và tiết kiệm không gian lưu trữ
            }
        }
    }
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <div class="box">
                ...
                <input type="text" name="property_name" required maxlength="50" placeholder="Enter property name"
                    value="<?= $fetch_property['property_name']; ?>" class="input">
            </div>
            <div class="flex">
                <div class="box">
                    <p>Property price <span>*</span></p>
                    <input type="number" name="price" required min="0" max="9999999999" maxlength="10"
                        value="<?= $fetch_property['price']; ?>" placeholder="Enter property price" class="input">
                </div>
                <div class="box">
                    <p>Deposite amount <span>*</span></p>
                    <input type="number" name="deposite" required min="0" max="9999999999"
                        value="<?= $fetch_property['deposite']; ?>" maxlength="10" placeholder="Enter deposite amount"
                        class="input">
                </div>
                <div class="box">
                    <p>Property address <span>*</span></p>
                    <input type="text" name="address" required maxlength="100" placeholder="Enter property full address"
                        class="input" value="<?= $fetch_property['address']; ?>">
                </div>
                <div class="box">
                ...
                <div class="box">
                    ...
                    <select name="status" required class="input">
                        <option value="<?= $fetch_property['status']; ?>" selected><?= $fetch_property['status']; ?>
                        </option>
                ...
                <div class="box">
                    ...
                    <select name="bhk" required class="input">
                        <option value="<?= $fetch_property['bhk']; ?>" selected><?= $fetch_property['bhk']; ?> BHK
                        </option>
                ...
                <div class="box">
                    ...
                    <select name="bedroom" required class="input">
                        <option value="<?= $fetch_property['bedroom']; ?>" selected><?= $fetch_property['bedroom']; ?>
                            bedroom</option>
                ...
                <div class="box">
                    ...
                    <select name="bathroom" required class="input">
                        <option value="<?= $fetch_property['bathroom']; ?>" selected><?= $fetch_property['bathroom']; ?>
                            bathroom</option>
                ...
                <div class="box">
                    ...
                    <select name="balcony" required class="input">
                        <option value="<?= $fetch_property['balcony']; ?>" selected><?= $fetch_property['balcony']; ?>
                            balcony</option>
                ...
                <div class="box">
                    ...
                    <input type="number" name="age" required min="0" max="99" maxlength="2"
                        placeholder="how old is property?" class="input" value="<?= $fetch_property['age']; ?>">
                </div>
                <div class="box">
                ...
                <div class="box">
                    ...
                    <input type="number" name="room_floor" required min="0" max="99" maxlength="2"
                        placeholder="property floor number" class="input" value="<?= $fetch_property['room_floor']; ?>">
                </div>
                <div class="box">
                    <p>Loan <span>*</span></p>
                    <select name="loan" required class="input">
                        <option value="<?= $fetch_property['loan']; ?>" selected><?= $fetch_property['loan']; ?>
                        </option>
            ...
            <div class="box">
                ...
                <textarea name="description" maxlength="1000" class="input" required cols="30" rows="10"
                    placeholder="Write about property..."><?= $fetch_property['description']; ?></textarea>
            </div>
            <div class="checkbox">
                <div class="box">
                ...
                <div class="box">
                    ...
                    <p><input type="checkbox" name="school" value="yes" <?php if ($fetch_property['school'] == 'yes') {
                                echo 'checked';
                            } ?> />School</p>
            ...
            <div class="flex">
                <div class="box">
                    ...
                    <input type="submit" value="delete image 02" name="delete_image_02" class="inline-btn"
                        onclick="return confirm('delete image 02');">
                    <?php } ?>
                    <p>Update image 02</p>
                ...
                <div class="box">
                    ...
                    <input type="submit" value="delete image 03" name="delete_image_03" class="inline-btn"
                        onclick="return confirm('delete image 03');">
                    <?php } ?>
                    <p>Update image 03</p>
                ...
                <div class="box">
                    ...
                    <input type="submit" value="delete image 04" name="delete_image_04" class="inline-btn"
                        onclick="return confirm('delete image 04');">
                    <?php } ?>
                    <p>Update image 04</p>
                ...
                <div class="box">
                    ...
                    <input type="submit" value="delete image 05" name="delete_image_05" class="inline-btn"
                        onclick="return confirm('delete image 05');">
                    <?php } ?>
                    <p>Update image 05</p>
